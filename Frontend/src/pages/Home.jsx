  ...
  return (
    <div className='h-screen relative overflow-hidden'>
      ...
      <div className='flex flex-col justify-end w-full h-screen absolute top-0'>
        <div className='h-[26%] p-5 bg-white relative'>
          ...
          <form onSubmit={(e) => {
            ...
            <input value={pickup} onChange={(e) => handlePickupChange(e)} onClick={() => {
              setPanelOpen(true),
                setActiveField('pickup')
            }} className='bg-[#eee] w-full px-10 py-2 mt-5 text-base rounded-lg font-uberMedium' type="text" placeholder='Add a pickup location' />
            <input value={destination} onChange={(e) => handleDestinationChange(e)} onClick={() => {
              setPanelOpen(true),
                setActiveField('destination')
          ...
          <button className='w-full p-3 mt-8 bg-black text-white text-2xl font-uberMedium rounded-lg' onClick={() => {
            findTrip()
          }}>
            Find Trip
          </button>
      ...
      <div ref={waitingForDriverRef} className='fixed z-1 bottom-0 translate-y-full bg-white px-3 py-10 w-full'>
        <WaitingForDriver
          ride={ride}
          setVehicleFoundPanelOpen={setVehicleFoundPanelOpen}
